...
MyApplication::MyApplication(const Arguments& arguments, const Corrade::Containers::StringView& title) :
...
void MyApplication::doOnTickEvent() {
    // Custom logic can be added in the derived class override of this method
    // A tick event happens at each application loop iteration, after processing input events and before drawEvent()    
}

}} // namespace Magnum::Examples

// Main is defined elsewhere
//MAGNUM_APPLICATION_MAIN(Magnum::Examples::MyApplication)
