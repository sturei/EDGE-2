...
protected:
    void SetUp() override {
        ...
        cylinder = FRepFixtures::cylinder(1.0, 2.0);
    ...
    FObject* cylinder;                    // unit radius, unit half-height cylinder centered at origin, axis aligned with z-axis
...
TEST_F(FSDFTest, FSDFTestCylinderEvaluate) {
    std::array<std::pair<Vec3d, double>, 3> positionAndExpectedSDF = {
