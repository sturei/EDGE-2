...
const actionSuggestions = [
    ...
    '{"type":"Gfx::hideSdfScene", "payload":{}}',
    '{"type":"Gfx::showSdfScene", "payload":{}}',
    '{"type":"Gfx::clearSdfScene", "payload":{}}',
    '------------- PRODUCT STRUCTURE ACTIONS (for testing) -------------',
    '{"type":"Gfx::addProductItem", "payload":{"displayName":"cell[0] (plane)", "pathName":"Unnamed (shape)/layout/body[0] (workplane)/cell[0]"}}',
