...
export type ShaderNodeType = 'sphere' | 'block' | 'cylinder' | 'circle' | 'rectangle' | 'roundRect' | 'profile' | 'extrusion' | 'halfSpace' | 'union' | 'intersection' | 'complement' | 'translation' | 'rotation';
